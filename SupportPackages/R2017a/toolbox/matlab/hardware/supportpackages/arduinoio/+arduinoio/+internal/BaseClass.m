classdef (Hidden) BaseClass < handle
    ...
    methods(Hidden,Sealed)
        ...
        function sobj = saveobj(obj)
            ...
            warning(message('MATLAB:hwshared:general:nosave', className));
    ...
    methods (Sealed, Access = protected)
        function result = renderCellArrayOfCharVectorsToCharVector(~,cellArray,separator)
            ...
            % between the original character vectors
    ...
    methods(Static,Sealed,Access=protected)
        function throwNotImplementedError()
            ...
            arduinoio.internal.BaseClass.localizedWarning('MATLAB:hwshared:general:notImplemented');
        end
        ...
        function text = getLocalizedText(id,varargin)
            ...
            % arbitrary character vectors to be substituted into the message.
            ...
            % a parameter is not a character vector.
            if ~(all(cellfun(@ischar,varargin)))
                error(message('MATLAB:hwshared:general:errorMessageParamNotString'));
            end
            
            
            % If you pass in an ID of 'MATLAB:hwshared:general:foobar' it will find the
            % foobar key in the <MATLABROOT>/resources/MATLAB/en/hwshared/general.xml
            % file.
        ...
        function localized_fprintf(id,varargin)
            ...
            % arbitrary character vectors to be substituted into the message. The
        ...
        function localizedError(id,varargin)
            ...
            % signature of error(id,varargin) allows arbitrary character vectors to be
        ...
        function localizedWarning(id,varargin)
            ...
            % character vectors to be substituted into the message.
    ...
    methods(Static, Sealed, Access=protected)
        function obj = getDefaultScalarElement() %#ok<STOUT>
            ...
            throwAsCaller(MException('MATLAB:hwshared:general:nosparse', 'Arduino'));
        end
    end
    ...
    methods(Access=private)
        function throwUnsupportedError(obj)
            ...
            e = arduinoio.internal.BaseClass.getLocalizedException('MATLAB:hwshared:general:unsupported',fcnName,class(obj));
            throw(e);
        end
    end
end
