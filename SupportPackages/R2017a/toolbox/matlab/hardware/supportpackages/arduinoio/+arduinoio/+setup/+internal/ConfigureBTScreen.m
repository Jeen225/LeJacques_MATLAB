classdef ConfigureBTScreen < matlab.hwmgr.internal.hwsetup.TemplateBase
    ...
    methods(Access = 'public')
        function obj = ConfigureBTScreen(workflow)
            ...
            obj.DocLink = arduinoio.setup.internal.ScreenHelper.buildHelpText(obj.ContentPanel, message('MATLAB:arduinoio:general:ConfigureBTScreenDocLinkText').getString, [140 350 200 25]);
    ...
    methods(Access = private)
        function configureDevice(obj, ~, ~)
            ...
            obj.StatusTable.Position= [20 150 160 80];
            ...
            if result
                ...
                obj.ConfigureFailureText.FontColor = arduinoio.setup.internal.ScreenHelper.RED;
